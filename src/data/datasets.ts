...
export const KAGGLE_DATASETS: Dataset[] = [
  {
    ...
    "kaggleSlug": "vivek468/superstore-dataset-final",
    "kaggleUrl": "https://www.kaggle.com/datasets/vivek468/superstore-dataset-final",
    ...
    "columns": [
      ...
      },
      {
        "name": "Ship Mode",
        "type": "string",
        "desc": "Shipping mode (Standard, First Class, etc.)"
      },
      {
        "name": "Customer ID",
        "type": "string",
      ...
      },
      {
        "name": "Segment",
        "type": "string",
        "desc": "Customer segment (Consumer, Corporate, etc.)"
      },
      {
        "name": "Country",
        "type": "string",
        "desc": "Country of the customer"
      },
      {
        "name": "City",
        "type": "string",
        "desc": "City of the customer"
      },
      {
        "name": "State",
        "type": "string",
        "desc": "State of the customer"
      },
      {
        "name": "Category",
        "type": "string",
      ...
      },
      {
        "name": "Sub-Category",
        "type": "string",
        "desc": "Product sub-category"
      },
      {
        "name": "Sales",
        "type": "float",
        "desc": "Sales value of the transaction"
      },
      {
        "name": "Quantity",
        "type": "integer",
        "desc": "Quantity of products ordered"
      },
      {
        "name": "Discount",
        "type": "float",
        "desc": "Discount applied to the order"
      },
      {
        "name": "Profit",
        "type": "float",
        "desc": "Profit generated from the transaction"
      }
    ],
    "sampleRows": [
      {
    ...
    "columns": [
      {
        "name": "track_name",
        "type": "string",
        "desc": "Name of the track"
      },
      {
        "name": "artist(s)_name",
        "type": "string",
        "desc": "Name of the artist(s)"
      },
      {
        "name": "released_year",
        "type": "integer",
        "desc": "Year the track was released"
      },
      {
        "name": "streams",
        "type": "integer",
        "desc": "Total number of streams on Spotify"
      },
      {
        "name": "bpm",
        "type": "integer",
        "desc": "Beats per minute (tempo)"
      },
      {
        "name": "danceability_%",
        "type": "integer",
        "desc": "Danceability percentage"
      },
      {
        "name": "energy_%",
        "type": "integer",
        "desc": "Energy percentage"
      },
      {
        "name": "acousticness_%",
        "type": "integer",
        "desc": "Acousticness percentage"
      },
      {
        "name": "instrumentalness_%",
        "type": "integer",
        "desc": "Instrumentalness percentage"
      },
      {
        "name": "liveness_%",
        "type": "integer",
        "desc": "Liveness percentage"
      },
      {
        "name": "speechiness_%",
        "type": "integer",
        "desc": "Speechiness percentage"
      }
    ],
    "sampleRows": [
      {
    ...
    "columns": [
      {
        "name": "id",
        "type": "integer",
        "desc": "Unique listing identifier"
      },
      {
        "name": "name",
        "type": "string",
      ...
      },
      {
        "name": "host_id",
        "type": "integer",
        "desc": "Unique host identifier"
      },
      {
        "name": "neighbourhood_group",
        "type": "string",
        "desc": "Broader area/borough (e.g., Manhattan, Brooklyn)"
      },
      {
        "name": "neighbourhood",
        "type": "string",
        "desc": "Specific neighborhood"
      },
      {
        "name": "latitude",
        "type": "float",
      ...
      },
      {
        "name": "room_type",
        "type": "string",
        "desc": "Type of room (Entire home, Private room, etc.)"
      },
      {
        "name": "price",
        "type": "integer",
        "desc": "Price per night in local currency"
      },
      {
        "name": "minimum_nights",
        "type": "integer",
        "desc": "Minimum stay requirement"
      },
      {
    ...
    "columns": [
      {
        "name": "show_id",
        "type": "string",
        "desc": "Unique ID for every Movie / TV Show"
      },
      {
        "name": "type",
        "type": "string",
        "desc": "Identifier - Movie or TV Show"
      },
      {
        "name": "title",
        "type": "string",
        "desc": "Title of the Movie / TV Show"
      },
      {
        "name": "director",
        "type": "string",
      ...
      },
      {
        "name": "cast",
        "type": "string",
        "desc": "Actors involved in the movie/show"
      },
      {
        "name": "country",
        "type": "string",
        "desc": "Country where the movie/show was produced"
      },
      {
        "name": "date_added",
        "type": "string",
        "desc": "Date it was added on Netflix"
      },
      {
        "name": "release_year",
        "type": "integer",
        "desc": "Actual release year of the movie/show"
      },
      {
        "name": "rating",
        "type": "string",
        "desc": "TV Rating of the movie/show"
      },
      {
        "name": "duration",
        "type": "string",
        "desc": "Total duration (in minutes or seasons)"
      },
      {
        "name": "listed_in",
        "type": "string",
    ...
    "columns": [
      {
        "name": "work_year",
        "type": "integer",
        "desc": "The year the salary was paid (e.g., 2020, 2021, 2022)"
      },
      {
        "name": "experience_level",
        "type": "string",
        "desc": "EN (Entry), MI (Mid), SE (Senior), EX (Executive)"
      },
      {
        "name": "employment_type",
        "type": "string",
        "desc": "PT (Part-time), FT (Full-time), CT (Contract), FL (Freelance)"
      },
      {
        "name": "job_title",
        "type": "string",
        "desc": "The role worked in during the year"
      },
      {
        "name": "salary",
        "type": "integer",
        "desc": "The total gross salary amount paid"
      },
      {
        "name": "salary_currency",
        "type": "string",
        "desc": "The currency of the salary paid as an ISO 4217 currency code"
      },
      {
        "name": "salary_in_usd",
        "type": "integer",
        "desc": "The salary converted to USD"
      },
      {
        "name": "employee_residence",
        "type": "string",
        "desc": "Employee's primary country of residence"
      },
      {
        "name": "remote_ratio",
        "type": "integer",
        "desc": "Overall amount of work done remotely (0, 50, 100)"
      },
      {
        "name": "company_location",
        "type": "string",
        "desc": "Country of the employer's main office"
      },
      {
        "name": "company_size",
        "type": "string",
        "desc": "S (Small), M (Medium), L (Large)"
      }
    ],
    "sampleRows": [
      {
  ...
  },
  {
    ...
    "columns": [
      ...
      },
      {
        "name": "IndicatorName",
        "type": "string",
        "desc": "Name of the development indicator"
      },
      {
        "name": "IndicatorCode",
        "type": "string",
        "desc": "Unique code for the indicator"
      },
      {
        "name": "Year",
        "type": "integer",
        "desc": "Year of measurement"
      },
      {
        "name": "Value",
        "type": "float",
        "desc": "Measured value of the indicator"
      }
    ],
    "sampleRows": [
      {
  ...
  },
  {
    ...
    "kaggleSlug": "subhamnandi/weather-data-of-kolkata",
    "kaggleUrl": "https://www.kaggle.com/datasets/subhamnandi/weather-data-of-kolkata",
    ...
    "columns": [
      {
        "name": "Date",
        "type": "string",
        "desc": "Date of measurement"
      },
      {
        "name": "Temperature_Max",
        "type": "float",
        "desc": "Maximum temperature in Celsius"
      },
      {
        "name": "Temperature_Min",
        "type": "float",
        "desc": "Minimum temperature in Celsius"
      },
      {
        "name": "Humidity_Mean",
        "type": "float",
        "desc": "Mean relative humidity percentage"
      },
      {
        "name": "Wind_Speed_Max",
        "type": "float",
        "desc": "Maximum wind speed in km/h"
      },
      {
        "name": "Precipitation_mm",
        "type": "float",
        "desc": "Total daily rainfall in mm"
      }
    ],
    "sampleRows": [
      {
